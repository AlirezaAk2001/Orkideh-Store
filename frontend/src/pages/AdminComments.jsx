...
const AdminComments = () => {
  ...
  alert("این فقط تست UI است. تأیید انجام نمی‌شود!");
  };
  ...
  useEffect(() => {
  setComments([
    { id: "1", productId: "1", productName: "محصول 1", user: "کاربر 1", rating: 4, text: "نظر نمونه", timestamp: new Date().toISOString(), approved: false },
  ]);
  setLoading(false);
  }, []);
